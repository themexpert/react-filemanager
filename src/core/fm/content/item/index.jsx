...
export default class Item extends Component {
  ...
  excerpt = () => {
    ...
    const max = 11;
    return basename.split('').length > max ? this.props.item.filename.substr(0, max) + '...' +
      (this.props.item.is_dir ? '' : this.props.item.extension) : basename;
  };
  ...
  render = () => {
    ...
    return (
      <div className="fm-grid-m">
        <div className={this.getMediaClass()} onDoubleClick={this.onDoubleClick} onClick={this.onClick}
